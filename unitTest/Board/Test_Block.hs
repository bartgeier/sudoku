...
test_Block :: UnitTestState -> IO ()
test_Block this = do
      test_snippetRow this 
      test_snippets this 
      test_frstBlock this 
      test_blockRow this 
      test_glueToBlocks this 
      test_blocks this 
      test_blockIdx this 
  
test_snippetRow :: UnitTestState -> IO ()
test_snippetRow this = do
      tst_EQUAL this [[Tmp "11",Tmp "11"],[Tmp "12",Tmp "12"]]
                (snippetRow 2 [Tmp "11",Tmp "11",Tmp "12",Tmp "12"])
      putStrLn("snippetRow, " ++ $__FILE__ ++ ", line " ++ show (($__LINE__)::Int))  

test_snippets :: UnitTestState -> IO ()      
test_snippets this = do
      tst_EQUAL this [[[Tmp "11",Tmp "11"],[Tmp "12",Tmp "12"]],[[Tmp "21",Tmp "21"],[Tmp "22",Tmp "22"]],[[Tmp "31",Tmp "32"],[Tmp "32",Tmp "32"]],[[Tmp "41",Tmp "42"],[Tmp "42",Tmp "42"]]] 
...
test_frstBlock :: UnitTestState -> IO ()     
test_frstBlock this = do
      tst_EQUAL this ([Tmp "1",Tmp "1",Tmp "2",Tmp "2"],  [[Tmp "3",Tmp "3"],[Tmp "4",Tmp "4"]])                
                (frstBlock 2 [[Tmp "1",Tmp "1"],[Tmp "2",Tmp "2"],[Tmp "3",Tmp "3"],[Tmp "4",Tmp "4"]])
      putStrLn("frstBlock, " ++ $__FILE__ ++ ", line " ++ show (($__LINE__)::Int)) 

test_blockRow :: UnitTestState -> IO ()       
test_blockRow this = do
      tst_EQUAL this ([[Tmp "1",Tmp "1",Tmp "2",Tmp "2"], [Tmp "3",Tmp "3",Tmp "4",Tmp "4"]],  [])
                (blockRow 2 [[Tmp "1",Tmp "1"],[Tmp "2",Tmp "2"],[Tmp "3",Tmp "3"],[Tmp "4",Tmp "4"]])
      putStrLn("blockRow, " ++ $__FILE__ ++ ", line " ++ show (($__LINE__)::Int)) 

test_glueToBlocks :: UnitTestState -> IO ()     
test_glueToBlocks this = do
      tst_EQUAL this [[[Tmp "11",Tmp "11",Tmp "12",Tmp "12"],[Tmp "13",Tmp "13",Tmp "14",Tmp "14"]],  
...
test_blocks :: UnitTestState -> IO ()      
test_blocks this = do
      tst_EQUAL this [[[Tmp "11",Tmp "12",Tmp "13",Tmp "21",Tmp "22",Tmp "23",Tmp "31",Tmp "32",Tmp "33"], [Tmp "14",Tmp "15",Tmp "16",Tmp "24",Tmp "25",Tmp "26",Tmp "34",Tmp "35",Tmp "36"], [Tmp "17",Tmp "18",Tmp "19",Tmp "27",Tmp "28",Tmp "29",Tmp "37",Tmp "38",Tmp "39"]],
...
test_blockIdx :: UnitTestState -> IO ()      
test_blockIdx this = do      
      tst_EQUAL this 0 (blockIdx 3 0)
      putStrLn("blockIdx, " ++ $__FILE__ ++ ", line " ++ show (($__LINE__)::Int)) 
      tst_EQUAL this 0 (blockIdx 3 1)
      putStrLn("blockIdx, " ++ $__FILE__ ++ ", line " ++ show (($__LINE__)::Int)) 
      tst_EQUAL this 0 (blockIdx 3 2)
      putStrLn("blockIdx, " ++ $__FILE__ ++ ", line " ++ show (($__LINE__)::Int)) 
      tst_EQUAL this 1 (blockIdx 3 3)
      putStrLn("blockIdx, " ++ $__FILE__ ++ ", line " ++ show (($__LINE__)::Int)) 
      tst_EQUAL this 1 (blockIdx 3 4)
      putStrLn("blockIdx, " ++ $__FILE__ ++ ", line " ++ show (($__LINE__)::Int)) 
      tst_EQUAL this 1 (blockIdx 3 5)
      putStrLn("blockIdx, " ++ $__FILE__ ++ ", line " ++ show (($__LINE__)::Int))   
      tst_EQUAL this 2 (blockIdx 3 6)
      putStrLn("blockIdx, " ++ $__FILE__ ++ ", line " ++ show (($__LINE__)::Int)) 
      tst_EQUAL this 2 (blockIdx 3 7)
      putStrLn("blockIdx, " ++ $__FILE__ ++ ", line " ++ show (($__LINE__)::Int)) 
      tst_EQUAL this 2 (blockIdx 3 8)
      putStrLn("blockIdx, " ++ $__FILE__ ++ ", line " ++ show (($__LINE__)::Int))        